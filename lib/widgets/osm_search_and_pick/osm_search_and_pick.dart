...
class _OpenStreetMapSearchAndPickState
  ...
  void setNameCurrentPos() async {
    ...
    var response = await client.get(Uri.parse(url), headers: {'User-Agent': 'HotelPalembangApp'});
          ...
          child: Stack(
            children: [
              Positioned.fill(
                child: FlutterMap(
                  options: MapOptions(
                      initialCenter: mapCentre ?? const LatLng(50.5, 30.51), initialZoom: 15.0, maxZoom: 18, minZoom: 6),
